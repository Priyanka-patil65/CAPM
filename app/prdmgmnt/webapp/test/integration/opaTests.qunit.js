...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/demo/prdmgmnt/test/integration/FirstJourney",
    "com/demo/prdmgmnt/test/integration/ProductsListJourney",
    "com/demo/prdmgmnt/test/integration/ProductsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
